    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <Section title="2. Descrierea serviciului">
          ...
          <p>Modelul de tarifare: <strong>0RON înregistrare</strong>, <strong>15% comision platformă</strong> din fiecare colaborare finalizată, <strong>5% fee</strong> la retragerea fondurilor de către influenceri.</p>
        </Section>
