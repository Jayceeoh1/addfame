      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12"
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center">
          ...
          <p className="text-gray-500 text-base leading-relaxed mb-10 max-w-sm">
            Gestionează campaniile, urmărește rezultatele și conectează-te cu cei mai buni micro-influenceri — totul într-un loc.
          </p>
          ...
          <div className="space-y-3 max-w-xs">
            <div className="float-1 bg-white/80 backdrop-blur-sm rounded-2xl p-4 border border-white/60 flex items-center gap-3" style={{ boxShadow: '0 8px 24px rgba(0,0,0,0.07)' }}>
              ...
              <div>
                <p className="text-xs font-black text-gray-900">+42K vizualizări azi</p>
            ...
            <div className="float-2 bg-white/80 backdrop-blur-sm rounded-2xl p-4 border border-white/60 flex items-center gap-3 ml-6" style={{ boxShadow: '0 8px 24px rgba(0,0,0,0.07)' }}>
              ...
              <div>
                <p className="text-xs font-black text-gray-900">8 aplicanți noi</p>
                <p className="text-xs text-gray-400">Dedeman · Campanie Iași</p>
              </div>
            </div>
            ...
            <div className="float-3 bg-white/80 backdrop-blur-sm rounded-2xl p-4 border border-white/60 flex items-center gap-3" style={{ boxShadow: '0 8px 24px rgba(0,0,0,0.07)' }}>
              ...
              <div>
                <p className="text-xs font-black text-gray-900">Reel livrat! 🎬</p>
                <p className="text-xs text-gray-400">@ana.frumos · 41K urmăritori</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <p className="text-sm text-gray-500"><span className="font-black text-gray-900">22+ branduri</span> cresc cu AddFame</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="fade-up d1">
            <h1 className="text-3xl font-black text-gray-900 mb-1">Autentificare</h1>
          ...
          {emailConfirmed && (
              <div className="fade-up mb-6 flex items-start gap-3 bg-green-50 border border-green-200 text-green-700 text-sm rounded-2xl p-4">
                <span className="text-xl">✅</span>
                <div>
                  <p className="font-black">Email confirmat cu succes!</p>
                  <p className="text-green-600 text-xs mt-0.5">Contul tău e activ. Loghează-te pentru a continua.</p>
                </div>
              </div>
            )}
            {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="fade-up d3">
              <div className="flex items-center justify-between mb-2">
                <label className="text-sm font-black text-gray-700">Parolă</label>
                <a href="/auth/forgot-password" className="text-xs font-semibold text-orange-500 hover:text-orange-600 transition-colors">Ai uitat parola?</a>
              </div>
          ...
          <div className="fade-up d5 flex items-center gap-4 my-6">
            ...
            <span className="text-xs text-gray-400 font-semibold">SAU</span>
            <div className="flex-1 h-px bg-gray-100" />
          </div>

          {/* Sign up CTA */}
          <div className="fade-up d5 text-center">
            <p className="text-sm text-gray-500 mb-3">Ești nou pe AddFame?</p>
