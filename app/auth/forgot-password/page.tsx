        ...
        <div className="bg-white rounded-3xl p-8" style={{ border: '1.5px solid #f0f0f0', boxShadow: '0 20px 60px rgba(0,0,0,0.06)' }}>
          ...
          {sent ? (
            <div className="text-center py-4">
              ...
              <p className="text-sm text-gray-500 mb-6">We've sent a password reset link to <span className="font-bold text-gray-700">{email}</span></p>
              <Link href="/auth/login" className="text-sm font-bold text-orange-500 hover:text-orange-700 flex items-center justify-center gap-1.5">
                <ArrowLeft className="w-4 h-4" /> Back to login
              </Link>
            </div>
          ) : (
            <>
              <h1 className="text-2xl font-black text-gray-900 mb-2">Reset your password</h1>
              <p className="text-sm text-gray-400 mb-7">Enter your email and we'll send you a reset link</p>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                      ...
                      className="w-full pl-10 pr-4 py-3 rounded-xl border-2 border-gray-100 text-sm font-medium outline-none transition focus:border-orange-400 focus:shadow-sm disabled:opacity-60"
