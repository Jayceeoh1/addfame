...
import { Users, LayoutDashboard, LogOut, ShieldCheck, Briefcase, ChevronRight, DollarSign, Building2, Menu, X, Handshake, ArrowUpRight, TrendingUp, Crown, Mail, Send, Bell, Package, Settings, CheckSquare, FileSignature, MessageCircle, PartyPopper } from 'lucide-react'
...
const NAV = [
  ...
  { icon: Package, label: 'Livrări', href: '/admin/deliveries' },
  { icon: CheckSquare, label: 'Dovezi', href: '/admin/reviews' },
  ...
  { icon: Bell, label: 'Anunțuri', href: '/admin/announcements' },
  { icon: Mail, label: 'Outreach', href: '/admin/outreach' },
  { icon: Mail, label: 'Email Blast', href: '/admin/email-blast' },
  { icon: Send, label: 'Invitații', href: '/admin/invite' },
...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  // Paginile de raport sunt standalone — fara sidebar admin
