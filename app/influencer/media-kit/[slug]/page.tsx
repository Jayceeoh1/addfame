      ...
      <div className="kit-wrapper" style={{ maxWidth: 800, margin: '32px auto', padding: '0 16px', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
        ...
        {inf.brand_bio && (
          <div className="kit-card" style={{ background: 'white', borderRadius: 20, padding: '20px', boxShadow: '0 2px 12px rgba(0,0,0,0.05)', marginBottom: 20 }}>
            <h3 style={{ fontSize: 12, fontWeight: 800, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.1em', margin: '0 0 12px' }}>
              Despre mine
            </h3>
            <p style={{ fontSize: 14, color: '#4b5563', lineHeight: 1.7, margin: 0, borderLeft: '3px solid #8b5cf6', paddingLeft: 14 }}>
              {inf.brand_bio}
            </p>
          </div>
        )}
        ...
        {/* De ce sa colaborezi */}
        {inf.why_choose_me?.filter((w: string) => w).length > 0 && (
          <div className="kit-card" style={{ background: 'white', borderRadius: 20, padding: '20px', boxShadow: '0 2px 12px rgba(0,0,0,0.05)', marginBottom: 20 }}>
            <h3 style={{ fontSize: 12, fontWeight: 800, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.1em', margin: '0 0 14px' }}>
              De ce să colaborezi cu mine
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {inf.why_choose_me.filter((w: string) => w).map((item: string, i: number) => (
